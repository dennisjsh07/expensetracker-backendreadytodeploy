...
async function generateDailyReport(){
    try{
        ...
        const response = await axios.get('http://16.16.204.15:3000/premium/generate-report/daily', {
...
async function generateMonthlyReport() {
    try {
        ...
        const response = await axios.get('http://16.16.204.15:3000/premium/generate-report/monthly', {
            headers: { 'Authorization': token },
            params: { reportMonth }
        });
...
async function generateYearlyReport() {
    try {
        ...
        const response = await axios.get('http://16.16.204.15:3000/premium/generate-report/yearly', {
            headers: { 'Authorization': token },
            params: { reportYear }
        });
